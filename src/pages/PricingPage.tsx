...
export const PricingPage: React.FC = () => (
  <>
    <Navbar />
    <main className="scale-[0.90] origin-top bg-gradient-to-b from-blue-50 via-white to-cyan-50 text-gray-900 py-24 px-4 overflow-hidden">
              ...
              <thead>
                <tr className="bg-white/70 text-blue-900 font-semibold">
                  ...
                  <th className="p-4 border border-white/50 text-center">
                    Starter<br /><span className="text-xs font-normal">(€65/m of €650/j)</span>
                  </th>
                  <th className="p-4 border border-white/50 text-center">
                    Standaard<br /><span className="text-xs font-normal">(€70/m of €700/j)</span>
                  </th>
                  <th className="p-4 border border-white/50 text-center">
                    Professional<br /><span className="text-xs font-normal">(€85/m of €850/j)</span>
                  </th>
                </tr>
              </thead>
