  ...
  <div className="bg-gradient-to-b from-blue-100 via-white to-cyan-100 min-h-screen text-gray-900 flex flex-col">
    ...
    <main className="pt-16 scale-[0.90] transform origin-top transition-transform duration-300 flex-grow">
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto bg-white/50 backdrop-blur-lg border border-white/30 rounded-3xl shadow-2xl p-8 sm:p-10">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-12 text-blue-900">Over TableTech</h1>
      ...
      {/* Geen padding tussen CallToAction en Footer */}
    ...
    {/* Footer direct onder CallToAction */}
    <Footer />
  </div>
);
