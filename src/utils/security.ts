...
export class SecurityManager {
  ...
  public getCSPHeader(nonce: string): string {
    const directives = [
      ...
      `connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://region1.google-analytics.com https://api.tabletech.nl https://tabletech.nl http://localhost:3001 ws://localhost:* wss://localhost:*`,
